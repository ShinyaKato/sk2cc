...
test_error "int main(int x, int x) { 0; }" "duplicated parameter definition."
...
test_error "int main() { continue; }" "invalid continue statement."
test_error "int main() { break; }" "invalid break statement."
test_error "int main() { return &123; }" "invalid operand type."
test_error "int main() { return *123; }" "invalid operand type."
